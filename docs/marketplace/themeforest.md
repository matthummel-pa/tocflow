# ThemeForest: how themes should feature TOCguide
...
> Long-form posts include a table of contents via **TOCguide**, a dedicated Gutenberg block (not baked into the theme). Headings stay in content; the outline is server-rendered for SEO.
