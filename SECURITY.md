...
This plugin does not call remote APIs and does not store personal data beyond normal WordPress options (`tocguide_settings`) and an optional per-user welcome-dismissal flag. See [PRIVACY.md](PRIVACY.md).
